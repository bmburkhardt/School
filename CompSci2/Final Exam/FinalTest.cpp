//FinalTest.cpp
//testing program for the Final takehome exam for CS202
//

// Includes for code to be tested
#include "Final.h"   // For class Money
#include "Final.h"   // Double inclusion test
